...
kable(data_tbl,
      "latex",
      booktabs = TRUE,
      caption = "\\label{tab:landscape-features}Landscape features") %>%
...
<!-- Suggest to remove this image: all ithe information it gives is already found in other figures: the location of the SoBi stations and the interpolated popualtion
...
kable(accessibility_income,
      ...
      caption = "\\label{tab:accessibility-by-income}Accessibility and population serviced by income quintile") %>%
  kable_styling(latex_options = c("striped", "scale_down")) %>%
