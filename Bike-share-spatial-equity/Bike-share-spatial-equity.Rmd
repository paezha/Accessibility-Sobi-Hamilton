...
ggplot() + 
  ...
  geom_tile(data = cbind(st_drop_geometry(population_50x50), st_coordinates(population_50x50)),
...
accessibility_3min <- accessibility %>% dplyr::filter(threshold == "3 min")
ggplot() +
  geom_sf(data = population_50x50,
          color = "gray") +
...
accessibility_5min <- accessibility %>% dplyr::filter(threshold == "5 min")
...
accessibility_10min <- accessibility %>% dplyr::filter(threshold == "10 min")
ggplot() +
  geom_sf(data = population_50x50,
          color = "lightgray") +
  #geom_sf(data = accessibility %>%
...
accessibility_15min <- accessibility %>% dplyr::filter(threshold == "15 min")
ggplot() +
  geom_sf(data = population_50x50,
          color = "lightgray") +
  #geom_sf(data = accessibility %>%
