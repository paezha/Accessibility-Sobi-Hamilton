...
```{r, include=FALSE}
sobi_downtown <- st_read("Community_Downtown.shp")
```
...
For the system without the equity stations we remove the equity stations from the travel time matrix before calculating accessibility in at most 3 minutes:
```{r}
...
For the system without the equity stations we remove the equity stations from the travel time matrix before calculating accessibility in at most 5 minutes:
```{r}
...
For the system without the equity stations we remove the equity stations from the travel time matrix before calculating accessibility in at most 15 minutes:
```{r}
